...
describe('continuesAssistant', () => {
  ...
  it.each([
    ...
    ['a previous message that is not assistant', { role: 'user', content: '', metadata: { messageId: 'm1' } } as ChatMessage, assistant('m1')],
    ['a next message that is not assistant', assistant('m1'), { role: 'user', content: '', metadata: { messageId: 'm1' } } as ChatMessage],
