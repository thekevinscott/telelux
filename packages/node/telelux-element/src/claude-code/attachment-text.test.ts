...
describe('attachmentText', () => {
  it.each([
    ['deferred_tools_delta', { type: 'deferred_tools_delta', addedNames: ['Bash'], removedNames: [] }, 'deferred_tools_delta +1'],
    ['agent_listing_delta', { type: 'agent_listing_delta', addedTypes: [], removedTypes: ['x', 'y'] }, 'agent_listing_delta -2'],
    ...
    ['total_tokens_reminder', { type: 'total_tokens_reminder', text: '<total_tokens>15 left</total_tokens>' }, '15 left'],
